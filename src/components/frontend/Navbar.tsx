      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <a href="/about" className="text-gray-700 hover:text-blue-600 font-medium text-lg pt-5">
              About
            </a>
            ...
            <a href="/contact" className="text-gray-700 hover:text-blue-600 font-medium text-lg pt-5">
              Contact Us
            </a>
          </div>
          ...
          <div className="hidden md:flex pt-3 -mr-10">
              <button className=" bg-[#1cb69d] text-white rounded-md w-[160px] h-[55px] font-medium text-xl">
                  Login/Register
              </button>
          </div>
