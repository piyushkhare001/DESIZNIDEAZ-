...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white pt-10 pb-5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:justify-between md:items-start">

          {/* Company Information */}
          <div className="md:w-1/4 mb-8 md:mb-0">
            <h2 className="text-4xl font-bold text-teal-400 tracking-wide">DESIZNIDEAZ</h2>
          ...
          {/* Navigation Links */}
          <div className="md:w-1/4 mb-8 md:mb-0">
            <h3 className="text-2xl font-semibold mb-4 text-teal-400">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <a href="/" className="hover:text-teal-300 transition-colors">Home</a>
              </li>
              <li>
                <a href="/courses" className="hover:text-teal-300 transition-colors">Courses</a>
              </li>
              <li>
                <a href="/about" className="hover:text-teal-300 transition-colors">About Us</a>
              </li>
              <li>
                <a href="/contact" className="hover:text-teal-300 transition-colors">Contact Us</a>
              </li>
            </ul>
          </div>
          ...
          {/* Support Links */}
          <div className="md:w-1/4 mb-8 md:mb-0">
            <h3 className="text-2xl font-semibold mb-4 text-teal-400">Support</h3>
            <ul className="space-y-2">
              <li>
                <a href="/faq" className="hover:text-teal-300 transition-colors">FAQs</a>
              </li>
              <li>
                <a href="/help" className="hover:text-teal-300 transition-colors">Help Center</a>
              </li>
              <li>
          ...
          <div className="md:w-1/4">
            <h3 className="text-2xl font-semibold mb-4 text-teal-400">Connect with Us</h3>
        ...
        <div className="md:flex md:items-center md:justify-between">
          <p className="text-center text-gray-400">
            &copy; 2024 DESIZNIDEAZ. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
